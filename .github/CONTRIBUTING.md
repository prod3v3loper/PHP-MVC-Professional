...
If you are still having difficulty after looking over your configuration carefully, please post a question to [StackOverflow with the MVC tag](http://stackoverflow.com/tags/mvc). This way you help others to help you.
...
Write here your [issues](https://github.com/prod3v3loper/php-mvc-professional/issues).
...
Show all [pulls](https://github.com/prod3v3loper/php-mvc-professional/pulls).