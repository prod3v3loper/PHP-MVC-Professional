...
<head>
    ...
    <title><?php echo (isset($data['title']) && $data['title'] ? $data['title'] : ''); ?> - <?php echo WEBSITE_NAME ?></title>

    <meta name="description" content="<?php echo (isset($data['description']) && $data['description'] ? $data['description'] : ''); ?>">
    <meta name="robots" content="<?php echo ($data['robots'] != '1' ? $data['robots'] : 'noindex, nofollow, noodp'); ?>">

    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="<?php echo PROJECT_HTTP_ROOT . DIRECTORY_SEPARATOR; ?>favicon.png">
    ...
    <!-- <link rel="shortcut icon" href="<?php echo PROJECT_HTTP_ROOT . DIRECTORY_SEPARATOR; ?>favicon.ico"> -->
    <link rel="icon" type="image/png" href="<?php echo PROJECT_HTTP_ROOT . DIRECTORY_SEPARATOR; ?>core/img/favicon.png" sizes="32x32">
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo PROJECT_HTTP_ROOT . DIRECTORY_SEPARATOR; ?>core/img/favicon.png">
